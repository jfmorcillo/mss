...
DAEMON=/home/eon/mandriva/svn/mmc-wizard-2/bin/web/webserver.py
# PID file to be created. It must match with the PID file in the
# configuration module.
PIDFILE=/var/run/mss-web.pid
...
# in the python path.
BASEDIR=/home/eon/mandriva/svn/mmc-wizard-2/bin/web/
# Config module for the webserver.
CONFIG=mss-web
#
####################################

DESC="Mandriva Server Setup HTTP server"
CWD="`pwd`"
